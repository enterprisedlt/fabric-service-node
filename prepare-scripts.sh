...
cat scripts-template/fabric-service-box-manager-start.sh | sed "s/@FABRIC_SERVICE_NODE_VERSION@/${FABRIC_SERVICE_NODE_VERSION}/g" >./fabric-service-node-scripts/fabric-service-box-manager-start.sh
