...
serviceID=`docker run -d \
 ...
 --volume=${SERVICE_NODE_HOME}/service-node/target/scala-2.12/service-node.jar:/opt/service/service-node.jar \
 --volume=${SERVICE_NODE_HOME}/service-chain-code/service/target/service-chain-code.tgz:/opt/service/service-chain-code.tgz \
