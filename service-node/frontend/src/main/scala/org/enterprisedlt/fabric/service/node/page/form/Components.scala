...
//import org.enterprisedlt.fabric.service.node.{AppState, Context, GlobalState, StateFieldBinder}
...
//      .build
//
//    class Backend(val $: BackendScope[Props, State]) extends StateFieldBinder[State] with GlobalStateAwareP[AppState, State, Props] {
//
