...
import org.enterprisedlt.fabric.service.node.cryptography.{FabricComponent, UserAccount}
...
trait CryptoManager {
    ...
    def createOrgCrypto(network: NetworkConfig, orgFullName: String, components: Array[FabricComponent]): Unit
